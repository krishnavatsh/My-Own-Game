...
bg = loadImage("images/bg1.png");
 ...
 overImg = loadAnimation("images/Over.gif")
...
function setup() {
  ...
  bomb = createSprite(115, 220 , 10 ,10)
  bomb.addImage(bombImg);
  bomb.velocityX = 3;
  bomb.scale = 0.07;

  end = createSprite(590,330,10,10);
  end.addImage(endImg);
  end.visible= false;
  end.scale = 2;
...
over = createSprite(700,330,10,10);
  over.addAnimation("Game Over", overImg);
  over.scale = 3
  over.visible = false;
}
